...
import { TentTree, Mail, Lock, User, Eye, EyeOff, Tent, LogIn } from "lucide-react";
...
export function Auth() {
  ...
  const { isAuth0Mode, loginWithAuth0 } = useAuth();
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // In Auth0 mode, redirect to Auth0
    if (isAuth0Mode) {
      loginWithAuth0();
      return;
    }

    // In local mode, navigate to dashboard
    navigate("/dashboard");
  };
